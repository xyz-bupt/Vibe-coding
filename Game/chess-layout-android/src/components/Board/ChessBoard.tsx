...
export const ChessBoard: React.FC<ChessBoardProps> = React.memo(({
  ...
  useEffect(() => {
    ...
    const loadImages = async () => {
      try {
        ...
        // Continue rendering even if images fail (use fallback)
        if (isMounted) {
          setImagesLoaded(true);
        }
      }
  ...
  }, [board, highlightedSquares, imagesLoaded, lastMove, drawBoardLines, drawHighlight, drawMoveHighlight, drawPieces]);

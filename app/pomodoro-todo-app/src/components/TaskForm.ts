...
export class TaskForm {
    ...
    const priorityInput: HTMLSelectElement;
    const pomodorosInput: HTMLInputElement;
    ...
    constructor() {
        ...
        this.descriptionInput = document.getElementById('task-description') as HTMLTextAreaElement;
        this.priorityInput = document.getElementById('task-priority') as HTMLSelectElement;
        this.pomodorosInput = document.getElementById('task-pomodoros') as HTMLInputElement;
